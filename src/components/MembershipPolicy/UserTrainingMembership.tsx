...
type UserTrainingMembershipProps = {
...
const UserTrainingMembership: FC<UserTrainingMembershipProps> = ({
  ...
  const getElement = (fieldName: string) => {
    if (fieldName === "trainingEvent") {
      return getSelectElementOptions("Training Event");
    }
    if (fieldName === "condition") {
      return getSelectElementOptions("Condition");
    }
    if (fieldName === "scope") {
      return getSelectElementOptions("Scope");
    }
    if (fieldName === "assignments") {
      return getSelectElementOptions("Assignments");
    }
    ...
    if (Object.keys(values).length) {
      const payload = {
        ...
        formContent: {
          ...
          trainingEvent: values.trainingEvent,
          timeFrame: {},
        },
      };
        ...
        <Row gutter={[30, 10]}>
          <Col xs={24} lg={12}>
            {getFormField({
              ...
              name: "trainingEvent",
              errorMsg: "Please select trainingEvent",
              type: "select",
              required: true,
            })}
          </Col>
        ...
        <Row gutter={[30, 10]}>
          ...
          <Col xs={24} lg={12}>
            {getFormField({
              label: "Assignments",
              name: "assignments",
              errorMsg: "Please select assignments",
              type: "select",
              required: true,
            })}
          </Col>
        ...
        <Row gutter={[30, 10]}>
          <Col xs={24} lg={12}>
            {getFormField({
              label: "Time Frame",
              name: "timeFrame",
              errorMsg: "Please select timeFrame",
              type: "radio",
              required: false,
            })}
          </Col>
...
export default UserTrainingMembership;
