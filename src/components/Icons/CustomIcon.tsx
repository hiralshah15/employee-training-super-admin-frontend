...
const CustomIcon: FC<CustomIconProps> = ({color = "#333333"}) => {
  return (
    <svg
      className="transition-colors duration-300 ease-in-out hover:stroke-red-500" // Tailwind classes for transition and hover effect
